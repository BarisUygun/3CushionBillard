...
public class DrawOffline_1v1 extends JPanel implements MouseListener,MouseMotionListener,ActionListener{
	...
	DrawOffline_1v1(JFrame jfr,int cuePow,Color col,JLabel tim,JLabel pow,JLabel scor,JLabel hghScor,JLabel trn){
		jf=jfr;
		lblTurn=trn;
		...
		lblPower=pow;
		lblscore=scor;
		lblscore.setText("SCORE_1:0");
		lblHighScore.setText("SCORE_2:0");
...
public void PreviousBallMovementMovement() {
	...
	public void CheckGameOver(){
		if(score_1>=50){
			t.stop();
			JOptionPane.showMessageDialog(null, "PLAYER_1:WON");
			jf.setVisible(false);
			Menu menu=new Menu();
			...
			t.stop();
			JOptionPane.showMessageDialog(null, "PLAYER_2:WON");
			jf.setVisible(false);
			Menu menu=new Menu();
		}
	}
	...
	public void actionPerformed(ActionEvent arg0) {
	 ...
	 if((velocityX>0 && velocityY>0) ||(PreviousvelocityX>0 && PreviousvelocityY>0)){
      ...
      if((velocityX<=0 || velocityY<=0) &&(PreviousvelocityX<=0 || PreviousvelocityY<=0)){
    	...
    	if(hitball_1 && hitball_2 && wallHitCounter>=0){ 
    		if(yourTurn){
    		score_1=score_1+25;
    		lblscore.setText("SCORE_1:"+score_1);
    		
    		yourTurn=false;
    		}
    		else{
    			score_2=score_2+25;
    			lblHighScore.setText("SCORE_2:"+score_2);
    			yourTurn=true;
    		}
